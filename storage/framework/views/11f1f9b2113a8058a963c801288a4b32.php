...
<?php $component = App\View\Components\InputFields::resolve(['type' => 'text','name' => 'mobilenumber','placeholder' => 'Mobile Number'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    ...
                    <div class="forgot text-center text-light mt-3">
                        <p>People who use our service may have uploaded your contact information to Instagram. <a href="" class="text-decoration-none fw-bolder">Learn More</a></p>
                        <p>By signing up, you agree to our Terms , <a href="" class="text-decoration-none fw-bolder">Privacy Policy and Cookies Policy</a> .</p>
